...
function Roadmap() {
  return (
    <section>
      ...
      <div className="max-w-4xl lg:mx-auto md:mx-10">
        <div className="md:grid md:grid-cols-12">
          ...
          >
            <div className="mt-20">
              <h3 className="h3 sm:text-2xl sm:text-center mt-8 mb-2 text-left font-red-hat-display font-extrabold">
                Core Team Est.
              ...
              <p className="text-gray-400 sm:text-center sm:mx-20 md:mx-0">
          ...
          <div className="col-start-8 col-span-5 mb-20 md:mt-20" data-aos="fade-left">
            ...
            <div className="mt-20">
              ...
              <ul className="md:list-disc ml-5 text-gray-400 sm:text-center sm:mx-20 md:mx-0">
